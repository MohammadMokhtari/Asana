...
namespace Asana.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220413101204_createData-updateData_ColumnInUserApplication")]
    partial class createDataupdateData_ColumnInUserApplication
    {
            ...
            modelBuilder.Entity("Asana.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 13, 14, 42, 4, 386, DateTimeKind.Local).AddTicks(379));
                    ...
                    b.Property<DateTime>("ModifiedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 13, 14, 42, 4, 390, DateTimeKind.Local).AddTicks(9130));
