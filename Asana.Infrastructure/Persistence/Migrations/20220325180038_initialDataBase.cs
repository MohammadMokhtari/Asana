    ...
    public partial class initialDataBase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FirstName = table.Column<string>(type: "nvarchar(220)", maxLength: 220, nullable: true),
                    LastName = table.Column<string>(type: "nvarchar(220)", maxLength: 220, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientFirstName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    RecipientLastName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    RecipientNationalCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_Cities_CityName",
                        column: x => x.CityName,
